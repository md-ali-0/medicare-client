            ...
            <div className="mx-auto w-full max-w-screen-xl py-6 lg:py-8">
                <div className="flex flex-col md:flex-row justify-between px-5 lg:px-0">
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <p className="mb-2 flex items-center justify-start text-gray-500 font-medium">
                                <svg
                            ...
                            <p className="mb-2 flex items-center text-gray-500 font-medium">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                ...
                <div className="flex items-center justify-center flex-col sm:flex-row sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <Link className="text-gray-500 hover:text-gray-900  ms-5 bg-white rounded-full shadow p-2">
